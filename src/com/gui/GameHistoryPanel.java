...
/*
    GameHistoryPanel extends the JPanel class
    this is for the gui to have a game history panel
    to show the moves of the players
*/
public class GameHistoryPanel extends JPanel {
    //fields
    private final DataModel model;
    private final JScrollPane scrollPane;
    private static final Dimension PANEL_DIMENSION = new Dimension(100,400);
    ...
    //to show if the move results in a check, checkmate, or stalemate
    ...
    private static class DataModel extends DefaultTableModel{
        ...
        public void setValueAt(final Object aValue, final int row, final int column){
            ...
            if(column == 0){
                ...
                fireTableRowsInserted(row, row); //adding a new row if column is 0
            } else if(column == 1){
